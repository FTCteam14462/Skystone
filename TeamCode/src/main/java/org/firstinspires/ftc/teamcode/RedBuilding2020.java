...
@Autonomous(name="Auto Red Build", group="Iterative Opmode")
//@Disabled
public class RedBuilding2020 extends OpMode {
    ...
    public void loop() {
        ...
        switch (step){
            ...
            case 6:
                if (leftDistance.getDistanceInches() < 63 && linefinder.isRedLine()){
                    driveTrain.drive_right(0.5);
                }
                else {
                    driveTrain.stop();
                    step = 7;
